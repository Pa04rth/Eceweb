...
// const Spinner = () => {
//   return (
//     <div className="spinner flex flex-col justify-center items-center h-screen bg-[url('/banner-mod.jpg')]">
//       <div>
//         <img
//           src={logo}
//           alt="Loading..."
...
//       <div>
//         {" "}
//         <h1 className="font-bold font-mono mt-1 text-2xl text-white">
